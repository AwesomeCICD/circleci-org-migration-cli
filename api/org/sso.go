...
func (c *Client) GetSSOEnforced(orgID string) (bool, error) {
...
func (c *Client) GetSSOConnection(orgID string) (connection map[string]any, found bool, err error) {
	...
	req, rerr := c.app.NewRequest("GET", u, nil)
	if rerr != nil {
